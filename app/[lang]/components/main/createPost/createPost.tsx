...
export const CreatePost = (props: any) => {
  ...
  const options = [
    {
      label: props.local.posts.postActivity.forAll,
      value: '0',
    },
    {
      label: props.local.posts.postActivity.forMe,
      value: '1',
    },
    {
      label: props.local.posts.postActivity.forFriends,
      value: '2',
    },
  ];
  return (
    <>
      <form className={styles.dialogDiv} >
        <div className={styles.dialogDivHeader}>
          <h2 className={styles.labels}>{props.local.posts.postActivity.title}</h2>
